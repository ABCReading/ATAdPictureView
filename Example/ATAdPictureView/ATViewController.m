...
@interface ATViewController ()<ATAdPictureViewDelegate, BannerViewDelegate>
@property (nonatomic, strong) BannerView *picView;
@end
...
//        }];
        BannerView *picView = [BannerView initWithFrame:CGRectZero
                                              withArray:@[]
                                               hasTimer:YES
                                               interval:3];
        _picView = picView;
...
- (void)touchesBegan:(NSSet<UITouch *> *)touches withEvent:(UIEvent *)event {
    ...
    [self.picView setupWithArray:picSource];
}
